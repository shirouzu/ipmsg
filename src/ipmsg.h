...
#define IPMSG_CLEANUP_TIMER			0x0110
...
public:
	...
	virtual void	InsertItem(int idx, char *buf, void *obj);
	virtual void	SetItem(int idx, int subIdx, char *buf);
	virtual void	Show(int mode = SW_NORMAL);
...
#define		KEY_INTERNAL	0x0004
	...
	BOOL	SetupRSAKey(KeyType key_type, int ctl_flg = 0);
